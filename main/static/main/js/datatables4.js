 ...
 *   https://datatables.net/download/#bs4-4.6.0/dt-2.3.0/b-3.2.3/fh-4.0.1/sl-3.0.0
 *
 * Included libraries:
 *   Bootstrap 4 4.6.0, DataTables 2.3.0, Buttons 3.2.3, FixedHeader 4.0.1, Select 3.0.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs4-4.6.0/dt-2.3.0/b-3.2.3/fh-4.0.1/sl-3.0.0",
